...
public class EmulatorManager {
    ...
    public DTOImageSearchResult searchTemplate(String emulatorNumber, EnumTemplates templatePath,
        ...
        return searchTemplate(emulatorNumber, rawImage, templatePath, topLeftCorner, bottomRightCorner, threshold);
    }

    /**
     * Searches for an image on the provided pre-captured screen of the emulator.
     */
    public DTOImageSearchResult searchTemplate(String emulatorNumber, DTORawImage rawImage, EnumTemplates templatePath,
            DTOPoint topLeftCorner, DTOPoint bottomRightCorner, double threshold) {
        checkEmulatorInitialized();
    ...
    public DTOImageSearchResult searchTemplate(String emulatorNumber, EnumTemplates templatePath, double threshold) {
        checkEmulatorInitialized();
        DTORawImage rawImage = captureScreenshotViaADB(emulatorNumber);
        return searchTemplate(emulatorNumber, rawImage, templatePath, threshold);
    }

    /**
     * Searches for an image on the entire pre-captured emulator screen.
     */
    public DTOImageSearchResult searchTemplate(String emulatorNumber, DTORawImage rawImage, EnumTemplates templatePath,
            double threshold) {
        checkEmulatorInitialized();
    ...
    /**
     * Searches for multiple instances of an image on the provided pre-captured
     * screen of the emulator.
     */
    public List<DTOImageSearchResult> searchTemplates(String emulatorNumber, DTORawImage rawImage,
            EnumTemplates templatePath,
            DTOPoint topLeftCorner, DTOPoint bottomRightCorner, double threshold, int maxResults) {
        checkEmulatorInitialized();
        String bestTemplatePath = getBestTemplatePath(templatePath.getTemplate());
    ...
    // ======================================================================
    // ScrcpyStreamCapture integration accessors
    // ======================================================================

    /**
     * Returns the ADB executable path for external tool integration.
     *
     * @return Absolute path to adb.exe
     */
    public String getAdbPath() {
        checkEmulatorInitialized();
        return emulator.getAdbPath();
    }

    /**
     * Returns the ADB device serial for the given emulator number.
     *
     * @param emulatorNumber Emulator identifier
     * @return Device serial (e.g. "127.0.0.1:16416")
     */
    public String getDeviceSerial(String emulatorNumber) {
        checkEmulatorInitialized();
        return emulator.getPublicDeviceSerial(emulatorNumber);
    }
