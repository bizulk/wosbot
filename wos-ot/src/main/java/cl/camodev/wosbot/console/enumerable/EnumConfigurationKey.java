...
public enum EnumConfigurationKey {
	...
	GATHER_ROTATION_POOL("", String.class),
	...
	BOOL_DO_EXPLORATION("false", Boolean.class),
	...
	POLAR_TERROR_MARCHES_INT("1", Integer.class),
	POLAR_TERROR_MARCH_1_FLAG_STRING("No Flag", String.class),
	POLAR_TERROR_MARCH_2_FLAG_STRING("No Flag", String.class),
	POLAR_TERROR_MARCH_3_FLAG_STRING("No Flag", String.class),
	POLAR_TERROR_MARCH_4_FLAG_STRING("No Flag", String.class),
	POLAR_TERROR_MARCH_5_FLAG_STRING("No Flag", String.class),
	POLAR_TERROR_MARCH_6_FLAG_STRING("No Flag", String.class),
	POLAR_TERROR_MODE_STRING("Limited (10)", String.class),

    // Manual Rally Join (Preemptive)
    RALLY_ENABLED_BOOL("false", Boolean.class),
    RALLY_MARCH_1_FLAG_STRING("No Flag", String.class),
    RALLY_MARCH_2_FLAG_STRING("No Flag", String.class),
    RALLY_MARCH_3_FLAG_STRING("No Flag", String.class),
    RALLY_MARCH_4_FLAG_STRING("No Flag", String.class),
    RALLY_MARCH_5_FLAG_STRING("No Flag", String.class),
    RALLY_MARCH_6_FLAG_STRING("No Flag", String.class),
    RALLY_MODE_STRING("Limited (10)", String.class),
    RALLY_MARCHES_INT("1", Integer.class),
    RALLY_TARGET_STRING("berserkCryptid", String.class),
	...
	/**
	 * Method that converts a String to the type defined in 'type'. Add conversions
	 * according to the types you need..
	 */
